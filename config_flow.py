"""Config flow for Integration OpenKarotz integration."""
...
STEP_USER_DATA_SCHEMA = vol.Schema(
    {
        vol.Required(CONF_HOST, description={"suggested_value": "192.168.1.170"}): str,
...
async def validate_input(hass: HomeAssistant, data: dict[str, Any]) -> dict[str, Any]:
    ...
    api = API(data[CONF_HOST] + "/cgi-bin/status")
    try:
